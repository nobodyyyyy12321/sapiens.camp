      ...
      <main className="w-full max-w-3xl py-12 px-16">
        ...
        <div className="space-y-4 mt-10 zen-subtle">
          <div className="flex items-center gap-2">
            <div className="text-lg font-light text-white">維基百科</div>
          ...
          <div className="flex items-center gap-2">
            <div className="text-lg font-light text-white">程式題庫</div>
          ...
          <div className="flex items-center gap-2">
            <div className="text-lg font-light text-white">Our World In Data</div>
          ...
          <div className="flex items-center gap-2">
            <div className="text-lg font-light text-white">World Population Review</div>
            <a href="https://worldpopulationreview.com/" target="_blank" rel="noopener noreferrer" className="text-sm zen-subtle hover:underline whitespace-nowrap">https://worldpopulationreview.com/</a>
                    ...
                    <div className="flex items-center gap-2">
            <div className="text-lg font-light text-white">Instagram Page</div>
          ...
          <div className="flex items-center gap-2">
            <div className="text-lg font-light text-white">阿摩線上測驗</div>
          ...
          <div className="flex items-center gap-2">
            <div className="text-lg font-light text-white">均一教育平台</div>
